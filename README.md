...
Camagru is the first web project from the 42 / WeThinkCode\_ curriculum, that aims to create a simple image editing and sharing application that allows users to post or upload images with frames or stickers, which other users within the application can comment and / or like.
